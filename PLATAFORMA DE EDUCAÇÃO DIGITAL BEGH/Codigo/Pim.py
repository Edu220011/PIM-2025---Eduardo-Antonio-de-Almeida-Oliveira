...
def adicionar_usuario():
    ...
    novo_usuario = {"nome": nome_hash,"idade":idade, "senha": senha_hash, "boletim": {}}
            ...
            while not sair:
             #Menu do usuário
                ...
                if opcao_usuario == 1:
                    ...
                    while not voltar_usuario:
                     #Menu perfil
                        opcao_perfil = exibir_menu(["[1] TROCAR SENHA","[2] EXCLUIR CONTA","[3] POLITICA DE SEGURANÇA","[4] VOLTAR"])
                        if opcao_perfil == 1:
